...
@call "%VS140COMNTOOLS%VCVarsQueryRegistry.bat" 32bit 64bit %1 %2
...
:end
set PATH_VC=%VSINSTALLDIR%VC\bin\amd64_x86;
set PATH_NASM=C:\Prog\NASM;
set PATH_MINGW=C:\Prog\MinGW\bin;
set PATH_CMAKE=C:\Program Files (x86)\CMake\bin;
set PATH_GIT=C:\Program Files\Git\cmd;C:\Program Files\Git\usr\bin;C:\Program Files\Git\mingw64\bin;
@REM set PATH_PERL=C:\Prog\Perl64\site\bin;C:\Prog\Perl64\bin;


@REM SET PATH=%PATH%%PATH_VC%%PATH_NASM%%PATH_MINGW%%PATH_CMAKE%%PATH_GIT%%PATH_PERL%

SET PATH=%PATH%%PATH_VC%%PATH_NASM%%PATH_MINGW%%PATH_CMAKE%%PATH_GIT%